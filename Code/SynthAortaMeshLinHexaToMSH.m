function SynthAortaMeshLinHexaToMSH(Mesh3dHexaLin, OutputFilename, ...
...
%% The mesh is assumed to be linear and hexahedral. 

% Minor: if the input filename is a string convert to chars
