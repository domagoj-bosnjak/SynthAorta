function Mesh = SynthAortaLoadLinMesh(Index, RefLevel)
...
FilenameXYZ = "./SynthAortaDataset/MeshNodes/MeshNodes_" + num2str(Index) + ".bin";
FilenameConnMat = ...
...
if ~isfile(FilenameXYZ) || ~isfile(FilenameConnMat)
    error("File does not exist; likely invalid RefLevel!" + ...
        " Check SynthAortaLoadLinMesh for details");
end
